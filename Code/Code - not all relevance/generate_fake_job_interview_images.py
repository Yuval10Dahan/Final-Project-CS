...
# Paths and constants
json_file_path = "json_files/job_interview_invitations.json"  # Path to the JSON file with letters
output_folder = "job_interview_images"  # Folder to save the images
