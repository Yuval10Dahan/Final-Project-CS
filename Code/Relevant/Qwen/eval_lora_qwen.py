...
# =========================
USE_DROPBOX      = True
DROPBOX_ZIP_URL  = "https://www.dropbox.com/scl/fi/liqqgo99uckyuzuda6laf/Eval_data.zip?rlkey=y1o1dufhrd1ja3l8csqy1ha4n&st=o87jxhsv&dl=1"
ZIP_LOCAL        = "Eval_data.zip"
EXTRACT_DIR      = "Eval_data_final"                 # where the zip will be extracted

# Prefer a JSONL next to this script, else we’ll search EXTRACT_DIR recursively.
JSONL_FILENAME   = "pii_eval_data_2k.jsonl"

OUTDIR           = "runs/qwen_pii_2k_lora"
