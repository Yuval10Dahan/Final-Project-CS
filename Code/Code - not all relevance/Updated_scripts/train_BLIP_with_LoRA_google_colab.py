...
def preprocess_data(batch):
    """Processes images and text for BLIP in smaller batches. Skips missing/corrupt images."""
    ...
    for image_path, text in zip(batch["image"], batch["text"]):
        ...
        try:
            ...
            print(f"⚠️ Skipping unreadable image: {image_path} ({e})")
            continue
...
if __name__ == "__main__":
    ...
    if os.path.exists(CACHE_DIR):
        ...
        dataset = load_dataset("json", data_files={"train": "annotations_fixed_drive.json"})
