...
# Paths and constants
json_file_path = "json_files/sensitive_fake_letters.json"  # Path to the JSON file with letters
output_folder = "letter_images/Sensitive"  # Folder to save the images
